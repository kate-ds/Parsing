...
class VacanciesHhSpider(scrapy.Spider):
    ...
    data_query = {
        ...
        'company_name': 'div.company-header span.company-header-title-name::text',
    ...
    def vacancy_parse(self, response: Response):
        ...
        return response.follow(link, callback=self.company_parse)
    ...
    # todo обработать description [e for e in list if e.strip()]
    # todo Проверить хрень с компаниями
